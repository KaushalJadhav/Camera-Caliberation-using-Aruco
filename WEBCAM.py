# Camera Caliberation performed wth webcam
...
# Different images had been obtained through mobile phone camera for caliberation
for c in {'1','2','3','4','5','6','7','8','9'}:
 img=cv2.imread('aruco pic'+c+'.jpeg')
